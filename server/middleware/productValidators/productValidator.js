...
const productDataValidation = () => {
      return [
            ...
            body('name')
                  ...
                  .withMessage('Product name must be 5 - 40 characters long.'),
            body('type')
                  .trim()
                  .isLength({ min: 5, max: 50 })
                  .withMessage('Product type must be 5 - 50 characters long.'),
            body('brand')
                  .trim()
                  .not()
                  .isEmpty()
            ...
            body('description')
                  ...
                  .withMessage('Product description must be 100 - 800 characters long.'),
            body('sizeSystem')
                  .trim()
                  .not()
                  .isEmpty()
                  .withMessage('Size system must be provided.'),
            check('sizeChart')
                  .isJSON()
                  .withMessage('Incorrect sizeChart format. It must be JSON.').bail()
